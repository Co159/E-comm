...
import { FORM_URL } from "../constant/api_url";
...
const Form = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!contact.phoneNumber) {
      ...
      newError.phoneNumber = "Phone number must be at least 10 characters long";
    }

    if (!contact.message) {
      newError.message = "Message is required";
    } else if (contact.message.length < 7) {
      newError.message = "Message must be at least 7 characters long";
    }
    ...
    try {
      const response = await apiCall(FORM_URL, "POST", contact);
